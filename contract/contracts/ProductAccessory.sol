...
contract ERC1155Tradable is ERC1155, Ownable {
  ...
  function uri(
    ...
    if (customUriBytes.length > 0) {
        return string(abi.encodePacked(customUri[_id], Strings.toString(_id)));
    } else {
...
contract ProductAccessory is ERC1155Tradable {
    ...
    constructor(address _proxyRegistryAddress)
        ERC1155Tradable(
            "Product Accessory",
            "PRDA",  
            "https://api.tokenmint.cc/api/erc1155/{id}",
            _proxyRegistryAddress
        ) {}

    function contractURI() public pure returns (string memory) {
        return "https://api.tokenmint.cc/api/contract/product-erc1155";
    }
    ...
    function mintTo(
        ...
        create(_to, newTokenId, _quantity, "https://api.tokenmint.cc/api/erc1155/", "");
